"""Figure 3 — the cost ramp WITH the 7 usable expansion cells (external
...
This IS the shipped Figure 3 (the paper describes the external cells);
the pre-expansion version lives in git history. Prints every plotted
point and the recomputed stats for verification.
"""
import json
import sys
...
ax.set_ylabel("utility cost of attribute removal\n(fraction of clean lift lost)")
