...
Outputs: analysis/yus_extras/tpr_failing59.json (+ tpr59_scores/*.npz,
...
SCORE_DIR = HERE / "tpr59_scores"
SCORE_DIR.mkdir(exist_ok=True)
OUT = HERE / "tpr_failing59.json"
CKPT = HERE / "tpr_failing59_ckpt.json"
SEEDS = [0, 1, 2]
TOL = 0.01
