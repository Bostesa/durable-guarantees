...
Results enter the paper only if the success criterion below holds AND Nathan
and his advisor sign off. Anything less: next-paper material, submission
unchanged.
...
Outputs: `analysis/yus_extras/hybrid_rr.json` + a results md scoring each
