...
after Nathan and advisor sign-off; anything less is next-paper material.
...
Outputs: analysis/yus_extras/hybrid_coarsen.json +
analysis/yus_extras/hybrid_coarsen_results.md scoring each prediction
