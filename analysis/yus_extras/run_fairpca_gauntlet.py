...
FAIRPCA_ROOT = Path("/Users/nathansamson/fair-pca")
...
def main():
    ...
    (HERE / "fairpca_gauntlet.json").write_text(json.dumps(out, indent=1, default=float))
    print(f"\n[save] {HERE / 'fairpca_gauntlet.json'} ({out['minutes']} min)", flush=True)
