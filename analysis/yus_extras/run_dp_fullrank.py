...
analysis/yus_extras/dp_bet.md (committed e87332b BEFORE this script existed).
...
def main():
    ...
    (HERE / "dp_fullrank.json").write_text(json.dumps(out, indent=1))
    print(f"\n[save] {HERE / 'dp_fullrank.json'} ({out['minutes']} min)",
          flush=True)
