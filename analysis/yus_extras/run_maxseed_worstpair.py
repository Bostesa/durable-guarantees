...
probability matrices in analysis/yus_extras/tpr_scores/*.npz, which hold
...
def main():
    ...
    (HERE / "maxseed_worstpair.json").write_text(json.dumps(out, indent=1, default=float))
    print(f"\n[save] {HERE / 'maxseed_worstpair.json'}")
