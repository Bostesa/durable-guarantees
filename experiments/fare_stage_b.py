...
Usage: PCRL_ROOT=... .venv/bin/python experiments/fare_stage_b.py
"""
...
def main():
    ...
    (RESULTS / "fare_gauntlet.json").write_text(json.dumps(out, indent=2))
    print(f"\n[save] {RESULTS / 'fare_gauntlet.json'}", flush=True)
